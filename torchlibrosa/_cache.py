...
cache: CacheManager = CacheManager(
    os.environ.get("TORCHLIBROSA_CACHE_DIR", None),
    mmap_mode=os.environ.get("TORCHLIBROSA_CACHE_MMAP", None),
    compress=os.environ.get("TORCHLIBROSA_CACHE_COMPRESS", False),
    verbose=int(os.environ.get("TORCHLIBROSA_CACHE_VERBOSE", 0)),
    level=int(os.environ.get("TORCHLIBROSA_CACHE_LEVEL", 10)),
)
